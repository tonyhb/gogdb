// File is generated by blink/devtools/scripts/CodeGeneratorFrontend.py
...
InspectorBackend.registerCommand("Runtime.getProperties", [{"name": "objectId", "type": "string", "optional": false}, {"name": "ownProperties", "type": "boolean", "optional": true}, {"name": "accessorPropertiesOnly", "type": "boolean", "optional": true}, {"name": "generatePreview", "type": "boolean", "optional": true}], ["result", "internalProperties"], false);
...
// ServiceWorkerCache.
InspectorBackend.registerCommand("ServiceWorkerCache.requestCacheNames", [], ["cacheNames"], false);
InspectorBackend.registerCommand("ServiceWorkerCache.requestEntries", [{"name": "cacheName", "type": "string", "optional": false}, {"name": "skipCount", "type": "number", "optional": false}, {"name": "pageSize", "type": "number", "optional": false}], ["cacheDataEntries", "hasMore"], false);
InspectorBackend.registerCommand("ServiceWorkerCache.deleteCache", [{"name": "cacheName", "type": "string", "optional": false}], [], false);
...
InspectorBackend.registerEnum("Canvas.CallArgumentSubtype", {Array: "array", Null: "null", Node: "node", Regexp: "regexp", Date: "date", Map: "map", Set: "set", Iterator: "iterator", Generator: "generator", Error: "error"});
